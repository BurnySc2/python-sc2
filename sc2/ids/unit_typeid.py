...
class UnitTypeId(enum.Enum):
    ...
    CHANGELINGSPITFIRE = 2005
    CHANGELINGXAYIDLING = 2006
    GENETRONPERFORMANCEMODEDUMMY = 2007
    GENETRONSTANDARDMODEDUMMY = 2008
    GENETRONOVERCLOCKMODEDUMMY = 2009
    MOLEBURROWED = 2010
    MOLEROOTED = 2011
    SCION_PROCESSORSTATIC = 2012
    SCION_PROCESSOR = 2013
    SCION_AVENGER = 2014
    COURIER = 2015
    JUPITER = 2016
    BOAR = 2017
    ...
    TECHVAULT = 2030
    ASSEMBLYARRAY = 2031
    ANALYSISTERMINAL = 2032
    GENERATOR = 2033
    OLYMPUS = 2034
    CHEMICALFIRM = 2035
    ORDNANCECACHE = 2036
    MOLE = 2037
    REPULSORBURROWED = 2038
    INTERDICTORBURROWED = 2039
    TORRENT = 2040
    TESLA = 2041
    INCITER = 2042
    VIRTUS = 2043
    ...
    MUTAGENCHAMBER = 2069
    CASNOLISKDEN = 2070
    BIOMASSHATCHERY = 2071
    BIOMASSCAVERN = 2072
    AVIANNEST = 2073
    CATALYSTPIT = 2074
    SUNKENWARREN = 2075
    BILEPIT = 2076
    MASSALISKHUNKERED = 2077
    SACRIFICIALMUTATION = 2078
    XAYIDLING = 2079
    SCORPALISK = 2080
    MENDLING = 2081
    CASNOLISK = 2082
    ...
    ELYTRON = 2124
    ECHODM = 2125
    PARIAHPROJECTION = 2126
    ACIDNESTBUILD = 2127
    WORM = 2128
    GRUB = 2129
    WASP = 2130
    INCITERPLACEHOLDER = 2131
    ACIDWORMSLMWEAPON = 2132
    CITADELCHARGED = 2133
    OLYMPUSDISCHARGEWEAPON = 2134
    GENETRONPOWERSUPPLYDUMMY = 2135
    WARDWEAPONLMWEAPON = 2136
    EVISCERATORSPINELMDUMMYWEAPON = 2137
    GYREANNEXDUMMY = 2138
    PARADOXSHACKLEWEAPON = 2139
    PULSAR4DMDUMMY = 2140
    MOLETURNDUMMY = 2141
    ENERVATORSPORESWEAPON = 2142
    NANITEGRENADEWEAPON = 2143
    HELLRAISERGUNSWEAPON = 2144
    LANCERAUTOGUNWEAPON = 2145
    CLOAKCHARGE = 2146
    LYNXCANNONWEAPON = 2147
    NEUTRALIZERBEAMLMWEAPON = 2148
    STINGERDRILLLMWEAPON = 2149
    STRATUMMISSILELAUNCHERWEAPON = 2150
    NEMESISMISSILESLMWEAPON = 2151
    VENGEANCEMISSILESLMWEAPON = 2152
    HURRICANEMISSILESLMWEAPON = 2153
    REVENANTBOMBLMWEAPON = 2154
    SHOCKCHARGE = 2155
    HALIFAXGRENADESLMWEAPON = 2156
    LAUNCHCLOAKCHARGEWEAPON = 2157
    LAUNCHSHOCKCHARGEWEAPON = 2158
    ADAPTIVEINJECTION = 2159
    SEARINGSPORE = 2160
    BILESWARMLMWEAPON = 2161
    COVERINGSPRAYMISSILE = 2162
    SHELLDOME = 2163
    EVISCERATORSPINELMWEAPON = 2164
    INCENDIARYINFUSIONMISSILE = 2165
    EXPLOSIVEGLOBMISSILE = 2166
    EXTERMINATIONMISSILE = 2167
    MASSALISKSPOREWEAPON = 2168
    MASSALISKSPOREWEAPONAA = 2169
    SCOURWEAPON = 2170
    SPITTERACIDWEAPON = 2171
    STAGNATINGBILEMISSILE = 2172
    VIRULENTSPITWEAPON = 2173
    VOLATILEDISCHARGEMISSILE = 2174
    EMISSARYORB = 2175
    HERALDENERGYCANNONSLMWEAPON = 2176
    AUGURYGUNSLMWEAPON = 2177
    KEIRONCHARGEDUMMY = 2178
    PARAGONAIR = 2179
    PARAGONGROUND = 2180
    BULWARKBLASTWEAPON = 2181
    SCION_WATCHER = 2182
    WEAPONCRUX = 2183
    ELECTRONBOLTWEAPON = 2184
    ECHOREVERB = 2185
    EMANATORMISSILE = 2186
    INDUCERATTACKMISSILE = 2187
    RETURNGAMUTORB = 2188
    ENTHRALLERQUILLSLMWEAPON = 2189
    AURORAATTACKMISSILE = 2190
    WEAPONSTRATUS = 2191
    TITANBLASTWEAPON = 2192
    SHADOWCANNONWEAPON = 2193
    INCITERELORPROTOCOLTARGETDUMMY = 2194
    FILTERINGPLANTRICH = 2195
    THEGREATEQUALIZERWEAPON = 2196
    SIPHONERRICH = 2197
    THRASHERSPINEWEAPON = 2198
    PARAGONSPAWN = 2199
